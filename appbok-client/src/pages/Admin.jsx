...
import AccountingIntegrationsTab from '../components/AccountingIntegrationsTab.jsx';
...
function SidebarAccountingIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="admin-page-root">
      ...
      <main className="admin-main">
        ...
        {activeTab === 'accounting' && <AccountingIntegrationsTab />}
        {activeTab === 'settings' && (
          isSuperAdmin ? (
